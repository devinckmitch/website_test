...
function RestaurantPageContent() {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <p className="text-[#c9a84c] text-xs tracking-[0.3em] uppercase mb-6">Fine Dining</p>
        <div
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <div key={label} className="flex gap-4">
                    <div style={{ width: '30px', height: '1px', backgroundColor: '#c9a84c' }} className="mt-3 flex-shrink-0" />
                    <div>
                      <h3
                        style={{ fontFamily: 'Cormorant Garamond, serif', color: '#1a3d2b' }}
