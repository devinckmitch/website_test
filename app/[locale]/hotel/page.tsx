            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={type} className="bg-white p-8 shadow-sm">
                  <div style={{ width: '30px', height: '1px', backgroundColor: '#E41F13' }} className="mb-6" />
                  <h3
                    style={{ fontFamily: 'FreightNeo, Georgia, serif', color: '#111111' }}
                  ...
                  <p style={{ color: '#E41F13' }} className="text-xs tracking-widest mb-4">
                    {size}
                  </p>
                  <ul className="space-y-2">
                    {features.map((f) => (
                      <li key={f} className="text-gray-400 text-xs flex items-center gap-2">
                        <span style={{ color: '#E41F13' }}>—</span> {f}
                      </li>
                    ))}
                  </ul>
