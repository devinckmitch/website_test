...
function ClubPageContent() {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <p className="text-[#c9a84c] text-xs tracking-[0.3em] uppercase mb-6">Est. 1908</p>
        <div
            ...
            <div className="lg:col-span-5">
              {[
                ...
                <div key={year} className="flex gap-6 mb-8">
                  ...
                  <div>
                    <div style={{ width: '20px', height: '1px', backgroundColor: '#c9a84c' }} className="mt-4 mb-3" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="text-center">
                <p
                  style={{ fontFamily: 'Cormorant Garamond, serif', color: '#c9a84c', opacity: 0.6 }}
