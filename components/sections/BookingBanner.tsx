      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          >
            ...
            <Link
              ...
              className="block text-center py-3 text-xs font-medium tracking-[0.1em] uppercase hover:bg-[#2d5a3d] transition-colors duration-200"
            >
              {t('bookCta')}
            </Link>
          </div>
        ...
        <div className="text-center">
          ...
          <a
            ...
            style={{ fontFamily: 'Cormorant Garamond, serif', color: '#1a3d2b', fontSize: '1.5rem' }}
